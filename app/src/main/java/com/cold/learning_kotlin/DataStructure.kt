package com.cold.learning_kotlin

class DataStructure {

    var age = 14
    var boolen: Boolean = true
    val myByts: Byte = 13
    var namingString: String = "hello buddy!"
    var count = namingString.length
    ...
    */ */
    ...
    Log.e("Reference Tag", "$myStr $namingString  ${namingString.length}")
}